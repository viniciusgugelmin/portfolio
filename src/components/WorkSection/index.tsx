            ...
            return (
              <SwiperSlide key={key}>
                <div className="flex flex-col justify-center items-center">
                  <h1 className="text-2xl text-xs md:text-sm font-bold text-center text-accent-1 dark:text-accent-6 mb-1">
                    {_role}
                    &nbsp;&nbsp;
